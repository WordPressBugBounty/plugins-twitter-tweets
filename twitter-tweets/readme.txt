...
* Tested upto php 8.2.24
* Minor CSS changes

= 2.1.8 =[11-02-2023]
* Tested upto WordPress 6.1.1
* Tested upto php 8.1
* Fixed: Undefined array key in Widgets
...
= 2.1.5 =[19-07-2022]
* php version support issue fixed.
...
= 1.7 - version update + WordPress 4.8.1 Compatible
